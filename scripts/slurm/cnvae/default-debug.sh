...
# Betas should have no effect so will use for IDing
betas=("0 0.1 2 10 150 150000 3456789")

logdir="logs-cnvae-debug"
...
do
    ...
    do
        for beta in $betas
        do
            model_name="pc-${projected_channels}-ws-${warmup_steps}-id-${beta}"
