...
betas=("0 0.5 1")
# Size=9
decoder_lr_factors=("0 0.00001 0.0001 0.0005 0.001 0.005 0.01 0.05 0.1")

logdir="logs-nvaeseg-pretrain-decoder-lr-tune"
...
do
    ...
    do
        for beta in $betas
        do
            for decoder_lr_factor in $decoder_lr_factors
            do
                model_name="pc-${projected_channels}-ws-${warmup_steps}-b-${beta}-lrf-${decoder_lr_factor}"
