...
from arch.nvae.decoder import DecoderCombinerCell, DecoderResidualCell
...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        self.initial_z_channels = initial_z_channels
    ...
    def get_top_latent_shape(self, batch_size: int) -> tuple[int, int, int, int]:
        return (batch_size, self.initial_z_channels, *self.top_latent_shape)
    ...
    def generate(
        ...
        if z is None:
            top_latent_shape = (num_samples, self.initial_z_channels, *self.top_latent_shape)
            distr = Normal(
